...
declare module '../../index' {
    class Vector {
         ...
         *   vector. A vector can be thought of in different
         *   ways. In one view, a vector is like an arrow
         *   pointing in space. Vectors have both magnitude
         ...
         *   class.
         *
         *   Note: createVector() is the recommended way to
        ...
        /**
         *   Adds to a vector's x, y, and z components. add()
         *   can use separate numbers, as in v.add(1, 2, 3),
         *   another p5.Vector object, as in v.add(v2), or an
         *   array of numbers, as in v.add([1, 2, 3]).
         *
         ...
         *   v.x by 4, v.y by 5, and v.z by 1. Calling mult()
